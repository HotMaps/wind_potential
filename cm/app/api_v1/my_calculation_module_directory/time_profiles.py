...
def wind_profile(lat, lon, height, capacity=800, raw=False, mean=None):
    """
    Return the dataframe with Wind turbine profile
    >>> df = wind_profile(lat=34.125, lon=39.814, height=50)
    >>> min(df['output'])
    0.0
    """
    # TODO: this is my personal token, how to manage it
    ...
    # modify the labels by deleting the year
    return df
# Enercon E48 800 for 50 m as reference plant
